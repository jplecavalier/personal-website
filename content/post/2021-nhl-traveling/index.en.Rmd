---
title: "How the 2021 reshuffling of NHL divisions will lessen traveling"
authors:
  - jplecavalier
date: 2021-01-19
...
[Montreal Canadiens](https://www.nhl.com/en/canadiens) and analyse the outcomes. For the first two
...
the 2021 season. We also add the actual divisions for a matter of making comparisons among them.
...
for the Western division. While the Anaheim Ducks will only need to travel a slight more than 17,000
km over the course of the season, the St. Louis Blues will accumulate just short of 35,000 km
(more than twice `r emoji("face_screaming_in_fear")`!) on the same period. We'll see if that
competitive advantage for the Ducks will prove enough to overcome their obvious lack of offensive
skills...

![](https://media.giphy.com/media/RNEGEAUjnQvzGRiCza/giphy.gif)

One sure thing, if the accumulated tiredness coming from traveling during the season is an important
factor on players' performance in playoffs, teams from the Eastern division will have a major
headstart when playing other teams this spring.
...
also be interesting to look at the relative change induce by those new divisions and the new
schedule patterns on each team. To do so, we will compare the 2021 season to seasons between 2013-14
(the last time the NHL shuffled the divisions before this year) and 2019-20.

Ww reuse the functions defined in the last section one after the other. Then, we compute average
...
global picture because they were shortened following the COVID-19 outbreak.
...
divisions, it still remains difficult to predict it all of this will have a significant impact on
the ice. The season promise to offer its share of unpredictable surprises, with some of them having
probably even greater consequences at the end. Moreover, it's important to remember that the
schedule presented in this post is up-to-date as of today, but is very likely to change with little
notice with COVID-19 local outbreaks. After all, there is nothing more we can do than to wait and
see, and of course, enjoy the show!
